...
function EventManager(options) { // assumed to be a calendar
    ...
    function buildEventFromInput(input, source) {
        ...
        if (input.dow || moment.isDuration(start) || moment.isDuration(end)) {
            ...
            out.start = start ? moment(start) : null; // will be a Duration or null
            out.end = end ? moment(end) : null; // will be a Duration or null
    ...
    function expandEvent(abstractEvent) {
        ...
        if (abstractEvent) {
            if (abstractEvent._recurring) {
                ...
                var check = abstractEvent.start.clone().subtract(2, 'days');
                var range = moment().range(check, abstractEvent.end)
